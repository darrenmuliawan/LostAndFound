...
class UserHome extends Component {
    ...
    componentDidMount() {
        axios.get("https://floating-dusk-33053.herokuapp.com/api/lostitems/?count&where={\"lostBy\":\"" + this.props.location.state.user._id + '"}').then(res => {
		...
		axios.get("https://floating-dusk-33053.herokuapp.com/api/users/" + this.props.location.state.user._id).then(res => {
			...
			for (i = 0; i < items.length; i++) {
			    axios.get("https://floating-dusk-33053.herokuapp.com/api/lostitems/" + items[i]).then(res => {
					this.setState({
